...
1. [Logging with parameters](#logging-with-parameters)

2. [More convenient DD](#more-convenient-dd)

3. [Log with context](#log-with-context)

4. [Quickly output an Eloquent query in its SQL form](#quickly-output-an-eloquent-query-in-its-sql-form)

5. [Log all the database queries during development](#log-all-the-database-queries-during-development)
