...
1. [Testing email into laravel.log](#testing-email-into-laravellog)

2. [Preview Mailables](#preview-mailables)

3. [Preview Mail without Mailables](#Preview Mail without Mailables)

4. [Default Email Subject in Laravel Notifications](#default-email-subject-in-laravel-notifications)

5. [Send Notifications to Anyone](#send-notifications-to-anyone)
