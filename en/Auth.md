...
1. [Check Multiple Permissions at Once](#check-multiple-permissions-at-once)

2. [More Events on User Registration](#more-events-on-user-registration)

3. [Did you know about Auth::once()?](#did-you-know-about-authonce)

4. [Change API Token on users password update](#change-api-token-on-users-password-update)

5. [Override Permissions for Super Admin](#override-permissions-for-super-admin)
